# source : https://github.com/openembedded/openembedded-core/blob/master/meta-skeleton/recipes-kernel/linux/linux-yocto-custom.bb

SUMMARY = "RETILS Lab custom kernel recipe that uses the linux-yocto and oe-core"
...
# point here to the kernel git repo 
...
# or use this if you want to take the latest commit of this branch
SRCREV = "${AUTOREV}"
